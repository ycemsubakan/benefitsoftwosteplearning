...
argparser.add_argument('-s', '--seed', type=int, help='random seed')
...
for config_num, Ks in enumerate(Kss):
    ...
    path = f'{models_dir}/audionet_jointtr_{joint_tr}_{args.data}_K_{Ks}.t'
    ...
    lr.output.write_wav('sample_{}.wav'.format(args.data), gen_data_concat, 8000, norm=True)
